...
import amnesia.lexer.GenericLexer;
...
abstract public class Monitor {
    ...
    protected static Logger errorLog = Logger.getLogger("amnesia.errors");
    protected static Logger sqliaLog = Logger.getLogger("amnesia.sqlia");
    ...
    static { 
    	...
    	try {
        	...
        	errorLog.severe("Problem loading the amnesia.properties file: " + message);
